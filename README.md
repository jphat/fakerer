...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/fakerer.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/fakerer)
...
```bash
php artisan vendor:publish --tag="fakerer-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="fakerer-config"
```
...
```bash
php artisan vendor:publish --tag="fakerer-views"
```

## Usage

```php
$fakerer = new Jphat\Fakerer();
echo $fakerer->echoPhrase('Hello, Jphat!');
```
...
- [EJ Josephat](https://github.com/jphat)
